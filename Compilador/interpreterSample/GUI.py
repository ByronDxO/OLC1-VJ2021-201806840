...
class Ventana():
    ...
    def interpretar(self):
        ...
        print(self.scroll.text.get(1.0, tk.END + "-1c"))
        print("separaicion")

        texto = interprete_perron(self.scroll.text.get(1.0, tk.END + "-1c")).getConsola()
        print("AZSD")
        print(texto)
        self.ast = interprete_perron(self.scroll.text.get(1.0, tk.END + "-1c"))
        asd = str(texto)
        self.scroll_consola = scrolledtext.ScrolledText(self.root_window, height=20, width=70, bg="gray")  # consola
