...
class ToLower(Funcion):
    ...
    def interpretar(self, tree, table):
        ...
        if simbolo == None : return Exception("Semantico", "No se encontró el parámetro de ToLower", self.fila, self.columna)

        if simbolo.get_tipo() != Tipo.CADENA:
            return Exception("Semantico", "Tipo de parametro de ToLower no es cadena.", self.fila, self.columna)
